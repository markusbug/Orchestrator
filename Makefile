...
.PHONY: build test race vet xcompile run-debug clean app-check app-live build-relay build-relay-linux run-relay-dev relay-load desktop-run desktop-build desktop-package deploy-site
