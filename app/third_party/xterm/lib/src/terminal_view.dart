...
class TerminalView extends StatefulWidget {
  ...
  /// The action shown on the soft keyboard's return key. [TextInputAction.newline]
  /// by default, which inserts a line feed; [TextInputAction.send] (or done/go)
  /// sends a carriage return like a hardware Enter key.
  /// (Orchestrator patch; not in upstream xterm 4.0.0.)
